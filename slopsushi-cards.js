(() => {
  ...
  const handmadeDecks={
    ...
    jacktrade:[
      C('Epic','Loaded Deck','Double or Nothing forks into two extra card lanes at every streak stage.',{sushiAttackForks:2}),
      C('Epic','Marked Cards','Cards become 40% larger, fly 35% faster, and travel 25% farther.',{sushiAttackSizePct:.4,sushiAttackSpeedPct:.35,sushiAttackRangePct:.25}),
      C('Epic','House Credit','Card damage heals JackTrade for 17% of damage dealt.',{lifestealPct:.17}),
      C('Mythic','Trade Dividend','Casting Trade of Fate restores 2 ammo and grants 2200 shield.',{superAmmo:2,superShield:2200,shieldCap:6500}),
      C('Mythic','Six-Way Wager','Every Trade of Fate releases six mini card shots around JackTrade.',{towerSuperOrbitCount:6,towerSuperOrbitDamagePct:.48}),
      C('Mythic','Dealer Stays','Every third card hit restores 12% Super and 0.4 ammo.',{thirdHitSuperCharge:12,thirdHitAmmo:.4}),
      C('Legendary','Winning Table','A defeat heals 1600 HP, reloads 1 ammo, and grants 22% speed.',{killHeal:1600,killAmmo:1,killSpeedPct:.22,killSpeedMs:3200}),
      C('Exotic','THE HOUSE GOES ALL IN','Double or Nothing fires seven piercing, homing card lanes; Trade of Fate restores full ammo, grants 4600 shield, and releases ten jackpot shots.',{sushiAttackForks:3,sushiAttackPierce:1,sushiAttackHoming:.82,sushiAttackHomingRadius:780,superAmmo:3,superShield:4600,shieldCap:9800,towerSuperOrbitCount:10,towerSuperOrbitDamagePct:.6})
    ],
    witch:[
