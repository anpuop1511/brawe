...
assert.match(game,/startAimingSuper\('mobile'\)[\s\S]{0,900}releaseSuper\(!superAimCancelState\.leftDeadZone \|\| superAimCancelState\.cancel\)/,'mobile Super drag supports fire and dead-zone cancellation');
...
assert.match(html,/20260902-mobile-v3-controls1/,'mobile rebuild assets are cache-busted');
assert.match(bootstrap,/20260902-mobile-v3-controls1/,'runtime game script is cache-busted');
