...
assert.match(html,/20260904-hyper-unlock-fix1/,'mobile rebuild assets are cache-busted');
assert.match(bootstrap,/20260904-hyper-unlock-fix1/,'runtime game script is cache-busted');
