...
assert.match(html,/20260902-mobile-v3-controls2/,'mobile rebuild assets are cache-busted');
assert.match(bootstrap,/20260902-mobile-v3-controls2/,'runtime game script is cache-busted');
