...
assert.match(html,/bootstrap\.js\?v=2026/,'mobile rebuild assets are cache-busted');
assert.match(bootstrap,/RELEASE_TOKEN = '2026/,'runtime game script is cache-busted');
